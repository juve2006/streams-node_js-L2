...
//*Щоразу, коли ви викликаєте process.nextTick() на цій фазі, всі коллбеки, передані процесу process.nextTick(), 
//будуть вирішуватися до того, як цикл подій продовжиться.
